        ...
        <Container>
          ...
          <Collapse isOpen={isOpen} navbar>
            <Nav navbar>
              ...
              <NavItem>
                <NavLink href="#UniqueApe">UniqueApe</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="#ApeMap">ApeMap</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/">Claim</NavLink>
              </NavItem>
              <NavItem>
                {!signedIn ? <Button className="SocialMedia3" style={{background: "#71B3FF"}} size="sm" onClick={connectMetamask}>CONNECT WALLET</Button>
                :
